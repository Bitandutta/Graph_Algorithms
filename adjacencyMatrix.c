...
int main(){
	int *adjMat1=NULL, v1=0, type1;
	int *adjMat2=NULL, v2=0, type2;
	
	printf("Graph 1\n");
	adjMat1 = initializeGraph(&v1); // for graph 1
	type1 = inputGraph(adjMat1, v1);
	
	printf("\nGraph 2\n");
	adjMat2 = initializeGraph(&v2); // for graph 2
	type2 = inputGraph(adjMat2, v2);
	
	printf("Graph 1\n");
	displayGraph(adjMat1, v1);  // display graph 1
	printf("\nGraph 2\n");
	displayGraph(adjMat2, v2);  // display graph 2
